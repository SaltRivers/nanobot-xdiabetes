"""Workspace bootstrap helpers for the clinical runtime."""
...
from xdiabetes.clinical.constants import (
    DIRECTORY_TEMPLATES,
...
def prepare_clinical_workspace(workspace: Path, mode: str, silent: bool = False) -> list[str]:
    """Create the clinical workspace with seeded assets.
    ...
    template_root = pkg_files("xdiabetes") / "templates" / "workspace_seed"
...
# Stable public alias preserved for backwards compatibility.
prepare_xdiabetes_workspace = prepare_clinical_workspace
