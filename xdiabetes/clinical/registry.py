"""Clinical workflow tool registration."""
...
from xdiabetes.agent.tools.diabetes import (
...
from xdiabetes.clinical.adapters import build_dtmh_adapter
from xdiabetes.clinical.services import (
    KnowledgeRouter,
    KnowledgeStore,
...
def register_clinical_tools(
    ...
    *,
    ...
    """Register the diabetes-specific tool suite on a tool registry."""
...
register_x_diabetes_tools = register_clinical_tools
