...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install x-diabetes-ai[matrix]"
    ) from e
...
from xdiabetes.config.paths import get_data_dir, get_media_dir
from xdiabetes.config.schema import Base
from xdiabetes.utils.helpers import safe_filename
